...
public class TapFly extends DemoBaseActivity implements SurfaceTextureListener, OnClickListener, OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        setContentView(R.layout.activity_tap_fly);
    ...
    private void setResultToToast(final String string) {
        TapFly.this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(TapFly.this, string, Toast.LENGTH_SHORT).show();
            }
        });
    }
