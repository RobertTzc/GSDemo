...
public class FpvActivity extends AppCompatActivity implements TextureView.SurfaceTextureListener, View.OnClickListener {
                        ...
                        FpvActivity.this.runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if (isVideoRecording){
                                    ...
                                    tool.writeTxtToFile(TimeStampString +"\tlatitude:"+Double. toString(droneLocationLat)+"\tlongtitude: "+Double. toString(droneLocationLng)+"\tAltitude: "+Double. toString(droneLocationAlt),
                                            filePath,fileName );
    ...
    private void initUI() {
        ...
        filePath = Environment.getExternalStorageDirectory()
                .getPath() + "/DJI_Log/";
        fileName = java.text.DateFormat.getDateTimeInstance().format(new Date())+".txt";
